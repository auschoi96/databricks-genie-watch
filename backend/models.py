"""Pydantic v2 models for GenieWatch.

Keep these in sync with `frontend/src/types/api.ts` whenever they change.
"""
...
class SpaceListItem(SpaceSummary):
    queries_7d: int = 0
...
class ResourceUsage(BaseModel):
    full_name: str
    kind: str = "table"          # 'table' | 'view' | 'metric_view'
    source: str = "configured"   # 'configured' | 'executed' | 'both'
    query_count: int = 0
